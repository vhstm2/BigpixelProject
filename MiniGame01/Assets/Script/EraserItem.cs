...
public class EraserItem : ITEM
{
    ...
    {
        has_enterAnim = Animator.StringToHash("EraserEnter");
        AnimStateName = "EraserAnimation";
    }
    ...
    public void Update()
    {
        ...
        //itemAnimExit = anim.GetCurrentAnimatorStateInfo(0).IsName("EraserAnimation") &&
        //    anim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.9f ? true : false;
